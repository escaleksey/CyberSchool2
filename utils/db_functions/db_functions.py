...
class DataBase:
    ...
    def add_employee(self, dict_of_value: dict) -> bool:
        ...
        cur = self.con.cursor()
        request = f'''INSERT OR IGNORE INTO employee(full_name, post, id_pk, authority, status, date)
         VALUES(
         "{list_of_value[0]}", "{list_of_value[1]}", {list_of_value[2]},
         "{list_of_value[3]}", "{list_of_value[4]}", "{list_of_value[5]}");'''
    ...
    def add_pk(self, dict_of_value: dict) -> bool:
        ...
        cur = self.con.cursor()
        request = f'''INSERT OR IGNORE INTO pk(type_pk, class_pk, details, amount_of_RAM, hard_disk,
        ...
        VALUES(
        "{list_of_value[0]}", "{list_of_value[1]}", "{list_of_value[2]}", "{list_of_value[3]}",
        "{list_of_value[4]}", "{list_of_value[5]}", "{list_of_value[6]}",
        {list_of_value[7]}, {list_of_value[8]}, "{list_of_value[9]}",
        {list_of_value[10]}, "{list_of_value[11]}", "{list_of_value[12]}",
        "{list_of_value[13]}", {list_of_value[14]}, "{list_of_value[15]}",
        "{list_of_value[16]}", "{list_of_value[17]}", {list_of_value[18]},
        {list_of_value[19]}, {list_of_value[20]}, "{list_of_value[21]}");'''
